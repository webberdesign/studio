...
$TB_DB_NAME = 'tb_studio_db';
$TB_DB_USER = 'tb_studio_db';
$TB_DB_PASS = 'WebberPass99!!!!!!';
...
/**
 * Get the currently configured theme (light or dark) from settings.json.
 * Defaults to 'light' if the file does not exist or cannot be parsed.
 *
